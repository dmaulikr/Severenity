...
public class TeamLogoFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCurrentTeamLogo = (ImageButton) view.findViewById(R.id.currentTeamLogo);
        mLogosImageButton = (ImageButton)view.findViewById(R.id.ic_team_1);
        mAddCustomIconBtn = (Button)view.findViewById(R.id.addCustomIconBtn);
        mSaveCustomIconBtn = (Button)view.findViewById(R.id.saveCustomIconBtn);
    ...
    protected void saveTeamLogoAsFile(ImageButton imageButton) {
    ...
    View.OnClickListener btnSaveCustomLogo = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            saveTeamLogoAsFile(mCurrentTeamLogo);
